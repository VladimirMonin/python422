...
Принципы DRY (Don't Repeat Yourself) и SRP (Single Responsibility Principle).
Определение и вызов функций.
Функции без аргументов и с аргументами.
Использование ключевого слова return.
Проверка типов данных в функциях.
Работа с множественными параметрами (*args).
Практические примеры и задания по созданию функций.
